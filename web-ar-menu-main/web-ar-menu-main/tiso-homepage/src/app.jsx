      ...
      (data.results.products || []).forEach(product => {
        ...
        if (categoryName) {
          ...
          productsByCategory[categoryName].push({
            ...
            // Add nutritional preferences and allergens
            preferences: product.nutritionalInformation?.preference || [],
            allergens: product.nutritionalInformation?.contains || [],
            // Add contains information
      ...
      <div className="main-layout" style={{ 
              ...
              >
                ...
                <div style={{
                  ...
                  <div style={{
                    ...
                    {/* Move contains text above the product name */}
                    {product.contains && (
                      <span style={{
                  ...
                  <div style={{
                    ...
                    marginBottom: '2px',
                    fontFamily: 'inherit',
                    marginTop: screenWidth > 600 ? '-18px' : '0' // Increased from -8px to -12px to move up more on desktop
                  }}>
                    <div style={{ width: '50%' }}>
                      <p style={{
                        color: '#fff',
        ...
        {showDescription && (
          <div className="description-modal" style={{
            position: 'fixed',
            top: isMobileScreen ? '50%' : '55%',
            left: '50%',
            transform: 'translate(-50%, -50%)',
            backgroundColor: theme === 'dark' ? '#232429' : 'white',
            ...
            <h2 style={{ margin: 0, fontSize: '1.15rem', fontWeight: 700, textAlign: 'center', color: theme === 'dark' ? '#fff' : '#222' }}>{showDescription.name}</h2>
            <hr style={{
              margin: '14px 0 10px 0',
              border: 0,
              borderTop: theme === 'dark' ? '1.2px solid #444' : '1.2px solid #eee'
            }}/>
            <p style={{ marginTop: '14px', fontSize: '0.98rem', color: theme === 'dark' ? '#fff' : '#222', textAlign: 'left' }}>
              {showDescription.description || 'No description available'}
            </p>
            
            {/* Debug logging */}
            {console.log('showDescription:', showDescription)}
            {console.log('preferences:', showDescription.preferences)}
            {console.log('allergens:', showDescription.allergens)}
            
            {/* Preferences and Allergens - Always show for debugging */}
            <div style={{ marginTop: '12px', fontSize: '0.9rem', color: theme === 'dark' ? '#fff' : '#222', textAlign: 'left' }}>
              <div style={{ marginBottom: '8px' }}>
                <strong>Preferences:</strong> {showDescription.preferences && showDescription.preferences.length > 0 ? showDescription.preferences.join(', ') : 'No preferences available'}
              </div>
              <div>
                <strong>Allergens:</strong> {showDescription.allergens && showDescription.allergens.length > 0 ? showDescription.allergens.join(', ') : 'No allergens available'}
              </div>
            </div>
          </div>
        )}
