...
import UpdateStockSheet from "../../components/more/update-stock-sheet";
...
const UpdateStock = () => {
  ...
  const handleUpdateStock = (isSuccess = false) => {
    if (scannedRef.current) {
      scannedRef.current = false;
  ...
  return (
    <View style={styles.mainContainer}>
      ...
      <View style={styles.container}>
        <Text style={styles.title}>{t("Scan the product barcode")}</Text>
        ...
        >
          <SearchSheet
            ...
            setScannedProduct={(prod: any) => {
              setScannedProduct({
                ...prod,
                type: prod?.type ? prod?.type : "product",
              });
              scannedRef.current = true;
            }}
          />
