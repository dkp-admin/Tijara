  ...
  return (
    ...
    >
      ...
      <MenuItem
        ...
        disabled={!billingSettings?.promotions || !hasPermission("promotions")}
      >
        <DefaultText
          fontSize="lg"
          fontWeight="medium"
          color={
            billingSettings?.promotions && hasPermission("promotions")
              ? theme.colors.text.primary
              : theme.colors.placeholder
          }
        >
      ...
      <MenuItem
        ...
        disabled={!billingSettings?.discounts || !hasPermission("discounts")}
      >
        <DefaultText
          fontSize="lg"
          fontWeight="medium"
          color={
            billingSettings?.discounts && hasPermission("discounts")
              ? theme.colors.text.primary
              : theme.colors.placeholder
          }
        >
      ...
      <MenuItem
        ...
        disabled={
          !billingSettings?.customCharges || !hasPermission("custom_charges")
        }
      >
        <DefaultText
          fontSize="lg"
