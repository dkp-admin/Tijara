...
import PaymentsOrders from "./payments/payments-orders";
import Refunds from "./refunds/refunds";
import TransactionHeaderOrders from "./transaction-header-orders";
import IssueRefundItemModalOrders from "./issue-refund/issue-refund-item-all-orders";
import RefundsOrders from "./refunds/refund-orders";

export default function TransactionHeaderModalOrders({
  orderData,
  totalAmount,
  visible = false,
  setSelectedOrder,
      ...
      >
        ...
        >
          ...
          {activeTab == 0 ? (
            ...
            <RefundsOrders data={orderData} origin="all-orders" />
          )}
        </View>
