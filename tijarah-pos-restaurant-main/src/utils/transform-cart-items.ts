...
export const transformCartItems = (cartItems: any, discountPercentage: any) => {
  ...
  cartItems?.map((cItem: any) => {
    ...
    items.push({
      ...cItem,
      categoryRef: cItem.categoryRef || null,
      ...
      kitchenRef: cItem?.kitchenRefs?.length > 0 ? cItem?.kitchenRefs[0] : null,
    });
  });
