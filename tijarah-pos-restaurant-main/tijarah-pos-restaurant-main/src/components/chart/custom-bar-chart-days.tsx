...
export default function CustomBarChartDays({
  data,
  width,
}: {
  data: any;
  ...
  return (
    ...
    >
      ...
      >
        <VictoryBar
          cornerRadius={14}
          labels={({ datum }) => `${currency} ${datum.y}`}
          dataComponent={
            <Bar
              style={{
                transform: `translate(0, -25)`,
                fill: ({ datum }: any) => {
                  return datum?.x == currentDay
          ...
          style={{ data: { fill: theme.colors.primary[100], width: 32 } }}
          events={[
            {
              target: "data",
              eventHandlers: {
                  ...
                  return [
                    {
                      ...
                      mutation: (props) => {
                        ...
                        return fill === theme.colors.primary[1000]
                          ? theme.colors.primary[100]
                          : {
                              style: {
                                ...props.style,
