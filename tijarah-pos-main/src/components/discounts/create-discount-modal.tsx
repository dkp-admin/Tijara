      ...
      onSubmit: async (values) => {
        ...
        try {
          ...
          if (res !== null || res?.code === "success") {
            ...
            debugLog(
              data.isAdd
                ? "Discount created to server"
                : "Discount updated to server",
              res,
          ...
          <ActionSheetHeader
              ...
              if (isEditing) {
                if (isConnected) {
                  ...
                  if (data.isAdd) {
                    ...
                    debugLog(
                      "Discount can't be updated offline",
                      {},
                      "discount-create-modal",
            ...
            permission={
              data.isAdd
                ...
                : authContext.permission["pos:coupon"]?.update
            }
          />
