...
export default function StockVariant({
  ...
  const checkStockActionable = Boolean(
    productId && variantId && formik.values.enabledTracking
  );
  ...
  return (
    <View>
              ...
              <View style={{ flexDirection: "row", alignItems: "center" }}>
                <View style={{ flex: 0.5 }}>
                  <TouchableOpacity
                    ...
                    onPress={() => {
                      debugLog(
                        "Stock update action modal opened",
                        {},
                        "add-variant-modal",
                        "handleOnPress"
                      );
                ...
                <View style={{ flex: 0.5 }}>
                  <TouchableOpacity
                    ...
                    onPress={() => {
                      debugLog(
                        "Stock & batch history modal opened",
                        {},
                        "add-variant-modal",
                        "handleOnPress"
                      );
      ...
      <StockAction
        ...
        handleClose={() => {
          debugLog(
            "Stock action update modal closed",
            {},
            "add-variant-modal",
            "handleClose"
          );
      ...
      <StockHistory
        ...
        handleClose={() => {
          debugLog(
            "Stock & batch history modal closed",
            {},
            "add-variant-modal",
            "handleClose"
          );
