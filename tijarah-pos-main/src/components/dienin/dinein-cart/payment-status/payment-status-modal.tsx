      ...
      >
        ...
        >
          <ActionSheetHeader
            ...
            isCurrency={true}
            rightBtnText={`${t("SAR")} ${total.toFixed(2)}`}
          />
          ...
          >
            ...
            >
              {order?.payment?.breakup?.map((pbreakup: any, index: number) => {
                return (
                  <View key={index} style={styles.content_view}>
                    ...
                    >
                      {`${t("SAR")} ${Number(pbreakup.total)?.toFixed(2)}`}
                    </DefaultText>
                  </View>
                );
              })}
              ...
              <View style={styles.content_view}>
                ...
                <DefaultText
                  ...
                  color={theme.colors.otherGrey[100]}
                >
                  {`${t("SAR")} ${(total - totalPaidAmount).toFixed(2)}`}
                </DefaultText>
              </View>
            </View>
            ...
            >
              {billingSettings?.paymentTypes?.map((payment: any, idx: any) => {
                if (
                  payment.name === "Wallet" &&
