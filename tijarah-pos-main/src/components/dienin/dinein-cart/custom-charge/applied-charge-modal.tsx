...
import AppliedChargeRow from "../../../billing/right-view/row/applied-charge-row";
import dineinCart from "../../../../utils/dinein-cart";

export default function AppliedChargeModalDinein({
  data,
  visible = false,
  handleClose,
}: {
              ...
              return (
                <AppliedChargeRow
                  ...
                  handleOnRemove={(data: any) => {
                    dineinCart.removeCharges(index, (charges: any) => {
                      debugLog(
                      ...
                      EventRegister.emit("chargeRemoved-dinein", charges);
                    });
                  }}
                />
              );
