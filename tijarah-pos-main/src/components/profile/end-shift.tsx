...
export default function EndShift({
  ...
  useEffect(() => {
    ...
    repo.billingSettings
      ...
      .then((result) => {
        debugLog(
          "Billing settings fetch from db",
          result,
          "end-shift-modal",
    ...
    repo.business
      ...
      .then((res) => {
        debugLog(
          "Business details fetch from db",
          res,
          "end-shift-modal",
      ...
      repo.order
        .find({
          where: [
            {
              deviceRef: deviceContext.user.deviceRef,
              paymentMethod: Like(`%${PROVIDER_NAME.CASH}%`),
          ...
          >
            ...
            >
              ...
              <AmountInput
                ...
                label={`${t("ACTUAL CASH AVAILABLE")}  (${t("in")} ${t(
                  "SAR"
                )})`}
                maxLength={18}
