...
export default function BillingProductPriceModal({
  data,
  visible = false,
  handleClose,
  onDelete,
  ...
  const handleUpdate = () => {
    ...
    const updatedDiscountedTotal = Number(data.discountedTotal);

    const updatedDiscountedVat = Number(data.discountedVatAmount);
