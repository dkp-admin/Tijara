...
export default function Payments({ data, setSelectedOrder }: any) {
  ...
  const renderDineinDetails = useMemo(() => {
    const order: any = [
      ...
      {
        title: t("Comp"),
        value: `SAR ${Number(compAmount || 0)?.toFixed(2) || 0}`,
        color: "text.primary",
      },
      {
        title: t("Void"),
        value: `SAR ${Number(voidAmount || 0)?.toFixed(2) || 0}`,
        color: "text.primary",
      },
    ];
