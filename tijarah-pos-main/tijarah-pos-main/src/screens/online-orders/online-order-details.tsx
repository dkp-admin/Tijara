            ...
            >
                ...
                {activeOrderStatus !== "completed" &&
                  activeOrderStatus !== "cancelled" && (
                    <View style={twoPaneView ? {} : { width: "50%" }}>
                      ...
                      >
                        {`${t("Payment of")} ${t("SAR")} ${(order?.payment
              ...
              >
                ...
                >
                  ...
                  <DefaultText fontSize="lg" fontWeight="normal">
                    {`${t("SAR")} ${(order?.payment?.subTotal || 0)?.toFixed(
                      2
                    )}`}
                  </DefaultText>
                </View>
                ...
                >
                  ...
                  <DefaultText fontSize="lg" fontWeight="normal">
                    {`+ ${t("SAR")} ${(order?.payment?.vatAmount || 0)?.toFixed(
                      2
                    )}`}
                  </DefaultText>
                </View>
                ...
                >
                  ...
                  <DefaultText fontSize="xl" fontWeight="medium">
                    {`${t("SAR")} ${(order?.payment?.total || 0)?.toFixed(2)}`}
                  </DefaultText>
                </View>
              </View>
