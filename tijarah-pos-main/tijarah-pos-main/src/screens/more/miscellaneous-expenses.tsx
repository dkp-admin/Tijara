...
export const fetchMiscExpensesApi = async (
  ...
  debugLog(
    "Miscellaneous expenses fetched from api",
    {},
    ...
    return (
      <EmptyOrLoaderComponent
        ...
        handleOnPress={() => {
          ...
          debugLog(
            "Create Miscellaneous Expenses modal opened",
            {},
            "misc-expenses-screen",
            "handleOnPress"
          );
    ...
    <>
      ...
      >
        <ExpensesTopHeader
          ...
          handleBtnTap={() => {
            debugLog(
              "Create expenses modal opened",
              {},
              "misc-expenses-screen",
              "handleCreateMiscExpenses"
            );
            setMiscExpensesData(null);
            setVisibleMiscExpenses(true);
          }}
