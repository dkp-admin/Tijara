...
object DefaultUblExtensionTemplate {
    ...
    fun populate(
        ...
        populatedTemplate = populatedTemplate.replace("SET_INVOICE_HASH", invoiceHash)
        populatedTemplate = populatedTemplate.replace("SET_SIGNED_PROPERTIES_HASH", signedPropertiesHash)
        populatedTemplate = populatedTemplate.replace("SET_DIGITAL_SIGNATURE", digitalSignature)
        populatedTemplate = populatedTemplate.replace("SET_CERTIFICATE", certificateString)
        populatedTemplate = populatedTemplate.replace("SET_SIGNED_PROPERTIES_XML", signedPropertiesXml)
